...
import com.sennin.dev.dogs.util.PERMISSION_SEND_SMS
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Getting the navigation Controller from the NavHostFragment
        navController = Navigation.findNavController(this, R.id.fragment)
        NavigationUI.setupActionBarWithNavController(this, navController)
    }

    override fun onSupportNavigateUp(): Boolean {
        //Setting on UP Navigation using the controller reference
        ...
        if (ContextCompat.checkSelfPermission(
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(
                ...
                AlertDialog.Builder(this)
                    ...
                    .setMessage("This app needs access to SMS.")
